<template>
  <div>
    <h3 class="bold lodan padding-lens">Landscape</h3>
    <ul class="container lodan">
      <li class="padding-lens" v-for="wa in landscape" :key="wa.id">
...
<script>
import landscape from '@/data/environment/landscape.json';
...
export default {
  ...
  methods: {
    getImagePath(id) {
      return new URL(`../assets/img/landscape/${id}.jpg`, import.meta.url).href; 
    },
