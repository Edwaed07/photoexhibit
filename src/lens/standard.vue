<template>
  <div>
    <h3 class="bold lodan padding-lens">Wide angle lens (35-135mm)</h3>
    <ul class="container lodan">
      <li class="padding-lens" v-for="wa in stand" :key="wa.id">
...
export default {
  ...
  methods: {
    getImagePath(id) {
      return new URL(`../assets/img/standard/${id}.jpg`, import.meta.url).href; 
    },
